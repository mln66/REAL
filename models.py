...
def load_model(name, dataset, n_class=10, in_channel=3, save_dir=None, substitute=False):
    ...
    elif name == 'resnet_tiny':
        model = ResNet_tiny(18, n_class)     
    ...
    elif name == 'wide-resnet_tiny':
        model = Wide_ResNet_tiny(28, 10, 0.3, n_class)
    ...
    if dataset == 'cifar10':
        ...
        model.add_normalizer(normalizer(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]))
