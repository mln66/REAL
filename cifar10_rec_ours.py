...
def train_main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % args.save_freq == 0:
            torch.save(model.state_dict(), '{}/latest_model{}.pth'.format(save_dir, epoch))
...
def parse_args():
    ...
    parser.add_argument('-n', '--name', default='wide-resnet_ae_noise', help='folder in the save path')
    ...
    # model and dataset
    parser.add_argument('-m', '--model', default='wide-resnet_ae', help='type of the model')
    parser.add_argument('-sm', '--sub-model', default='wide-resnet_ae', help='type of the substitute model')
    parser.add_argument('-d', '--dataset', default='cifar100', help='name of the dataset')
